...
def create_sampling_ui(model_config, inpainting=False):
    ...
    video_examples = gr.Examples(examples=[
        [True, "./efficient_video_bgm/Video_LLaMA/demo_videos/Better_Call_Saul2.mp4"],
        [True, "./efficient_video_bgm/Video_LLaMA/demo_videos/Better_Call_Saul4.mp4"],
        [True, "./efficient_video_bgm/Video_LLaMA/demo_videos/breakingbad_4.mp4"],
        [True, "./efficient_video_bgm/Video_LLaMA/demo_videos/breakingbad_6.mp4"],
        [True, "./efficient_video_bgm/Video_LLaMA/demo_videos/friends_2.mp4"],
        ], 
    ...
    prompt_melody_examples = gr.Examples(examples=[
        ["Guitar, Piano, Bass", "Jazz", "130 bpm", True, "./efficient_video_bgm/Video_LLaMA/demo_videos/drums.wav", 5],
        ["Piano", "Ambient, Slow", "70 bpm", True, "./efficient_video_bgm/Video_LLaMA/demo_videos/1908-4.wav", 3],
        ], 
